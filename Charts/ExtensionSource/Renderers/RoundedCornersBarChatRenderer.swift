...
open class RoundedCornersBarChatRenderer: BarLineScatterCandleBubbleRenderer {
    ...
    open override func initBuffers()
    {
        if let barData = dataProvider?.barData
        {
            ...
            {
                let set = barData.dataSets[i] as! IRoundedCornersBarChartDataSet
    ...
    private func prepareBuffer(dataSet: IRoundedCornersBarChartDataSet, index: Int)
    {
        guard
    ...
    open override func drawData(context: CGContext)
    {
        ...
        for i in 0 ..< barData.dataSetCount
        {
            ...
            if set.isVisible
            {
                if !(set is IRoundedCornersBarChartDataSet)
                {
                    fatalError("Datasets for BarChartRenderer must conform to IRoundedCornersBarChartDataSet")
                }
                
                drawDataSet(context: context, dataSet: set as! IRoundedCornersBarChartDataSet, index: i)
            }
        }
    ...
    @objc open func drawDataSet(context: CGContext, dataSet: IRoundedCornersBarChartDataSet, index: Int)
    {
    ...
    open override func drawValues(context: CGContext)
    {
        ...
        if isDrawingValuesAllowed(dataProvider: dataProvider)
        {
            ...
            {
                guard let
                    dataSet = dataSets[dataSetIndex] as? IRoundedCornersBarChartDataSet,
    ...
    open override func drawHighlighted(context: CGContext, indices: [Highlight])
        {
            ...
            {
                guard
                    let set = barData.getDataSetByIndex(high.dataSetIndex) as? IRoundedCornersBarChartDataSet,
    ...
    internal func createAccessibleElement(withIndex idx: Int,
                                          ...
                                          dataSet: IRoundedCornersBarChartDataSet,
                                          dataSetIndex: Int,
                                          stackSize: Int,
