//
//  ColumnRangeBarChartDataSet.swift
//  Charts
//
...
open class ColumnRangeBarChartDataSet: LineScatterCandleRadarChartDataSet, IColumnRangeBarChartDataSet {
    ...
    {
        guard let e = e as? ColumnRangeBarChartDataEntry
            else { return }
