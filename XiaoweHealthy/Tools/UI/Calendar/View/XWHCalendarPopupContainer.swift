//
//  XWHCalendarPopupContainer.swift
//  XiaoweHealthy
//
...
class XWHCalendarPopupContainer: UIView {
    ...
    open class func generatePopupWithView(_ view: UIView) -> XWHCalendarPopupContainer {
        let popupContainer = XWHCalendarPopupContainer()
        
        UIDevice.current.beginGeneratingDeviceOrientationNotifications()
        NotificationCenter.default.addObserver(
            popupContainer,
            selector: #selector(XWHCalendarPopupContainer.interfaceOrientationChanged(_:)),
