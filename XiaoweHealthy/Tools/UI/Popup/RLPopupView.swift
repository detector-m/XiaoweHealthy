...
public protocol RLPopupViewAnimator {
    ...
    ///   - popupView: PopupView
    ///   - contentView: 自定义的弹框视图
    func refreshLayout(popupView: RLPopupView, contentView: UIView)
...
public class RLPopupView: UIView {
    /*
     举个例子
     /////////////////////
     ///////////////////B/
    ...
    let animator: RLPopupViewAnimator
    ...
    public init(containerView: UIView, contentView: UIView, animator: RLPopupViewAnimator = RLFadeInOutAnimator()) {
...
public extension UIView {
    ...
    func popupView() -> RLPopupView? {        
        for view in subviews {
            if view.isKind(of: RLPopupView.self) == true {
                return view as? RLPopupView
            }
        }
...
open class RLBaseAnimator: RLPopupViewAnimator {
    ...
    open func refreshLayout(popupView: RLPopupView, contentView: UIView) {
